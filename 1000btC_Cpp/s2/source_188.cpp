...
void XuLyDuLieu(int a[],int b[],int n)
{
	...
	for(int j=0;j<dem;j++)
	{
		...
		if(dem1>1) // Đặt trường hợp biến đếm lớn hơn 1 thì in ra các giá trị thỏa . Đó là các giá trị xuất hiện trong dãy quá 1 lần .
		{
...
void main()
{
	...
	XuatMang(a,n);
	printf("\n");
	printf("\n>>>>>>>>>>>Cac Gia Tri Xuat Hien Trong Day Qua 1 Lan La:<<<<<<<<<<<<<\n");
	SapMangTangDan(a,n);
	XuLyDuLieu(a,b,n);
	printf("\n");
