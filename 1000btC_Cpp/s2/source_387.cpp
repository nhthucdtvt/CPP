...
void duoiduongcheochinh(float a[MAX][MAX],int m,int n)
{
	float min=FLT_MAX;
	for(int i=1;i<m;i++)
	{
	...
	printf("\nGia tri nho nhat cua ma tran tam giac duoi duong cheo chinh la:%f",min);
}
void duoiduongcheophu(float a[MAX][MAX],int m,int n)
{
	float min=FLT_MAX;
	for(int i=1;i<m;i++)
	{
	...
	printf("\nGia tri nho nhat cua ma tran tam giac duoi duong cheo phu la:%f",min);
}
void main()
{
	float a[MAX][MAX];
	...
	duoiduongcheochinh(a,m,n);
	duoiduongcheophu(a,m,n);
