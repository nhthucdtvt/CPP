...
void tongtrenduongcheochinh(float a[MAX][MAX],int m,int n)
{
	float tong=0;
	for(int i=0;i<m-1;i++)
	{
	...
	printf("\nTong cac phan tu thuoc ma tran tam giac tren duong cheo chinh la:%f",tong);
}
void tongtrenduongcheophu(float a[MAX][MAX],int m,int n)
{
	float tong=0;
	for(int i=0;i<m-1;i++)
	{
	...
	printf("\nTong cac phan tu thuoc ma tran tam giac tren duong cheo phu la:%f",tong);
}
void main()
{
	float a[MAX][MAX];
	...
	tongtrenduongcheochinh(a,m,n);
	tongtrenduongcheophu(a,m,n);
